...
%token CONST_INT CONST_CAR CMD_PROGRAMA TYPE_INT TYPE_CAR CMD_RETORNE CMD_LEIA CMD_ESCREVA NOVA_LINHA CMD_SE CMD_ENTAO CMD_SE_NAO CMD_ENQUANTO CMD_EXECUTE ABRE_PARENTESES FECHA_PARENTESES ABRE_CHAVE FECHA_CHAVE VIRGULA PONTO_VIRGULA ATRIBUICAO NEGACAO OU E IGUAL DIFERENTE MENOR_QUE MAIOR_QUE MAIOR_IGUAL_QUE MENOR_IGUAL_QUE SOMA SUBTRACAO MULIPLICACAO DIVISAO ID ABRE_COMENTARIO FECHA_COMENTARIO UNKNOWN
